...
const placetender = async (e)=>{
  ...
  return (
    <>
      connected: {account}
      <div>
        <form onSubmit={placetender}>
          <input onChange={(e)=>setid(e.target.value)} type="text" placeholder="id" />
          <input onChange={(e)=>setname(e.target.value)} type="text" placeholder="name" />
          <input onChange={(e)=>setdescription(e.target.value)} type="text" placeholder="discription" />
          <input onChange={(e)=>settime(e.target.value)} type="text" placeholder="endtime" />
